...
class HiglassResultUiOnly extends React.Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (this.props.windows !== prevProps.windows) {
      this.setState({ windows: this.props.windows });
    }
  }
          ...
          <div className="higlass-class-probability-wrapper">
            ...
            >
              <ButtonRadio
                ...
                selection={
                  (this.state.windows[this.props.windowId] &&
                    this.state.windows[this.props.windowId].classification) ||
